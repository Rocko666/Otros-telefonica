...
def fun_cargar_df_otc_t_descuentos_planes_act(sqlContext, val_fecha_dia_bigint, val_ini_mes_actual_ini, val_fecha_proc):
    ...
    ## El valor del descuento a considerar debe ser sin impuestos, por lo cual se comenta la variable 'DISCOUNT_VALUE as DESCUENTO_TARIFA_PLAN_ACT'
    ## y se asigna a descuento total el descuento sin impuesto con el objetivo de no afectar los procesos posteriores que utilizan esta variable
    ## FECHA DE MODIFICACION: 05/08/2022
    df_otc_t_descuentos_planes_act_tmp = df_otc_t_descuentos_planes_act_tmp.selectExpr('PHONE_NUMBER as TELEFONO'
                                                                ##,'DISCOUNT_VALUE as DESCUENTO_TARIFA_PLAN_ACT'
                                                                ,'DISCOUNT_VALUE_WITH_TAX as DESCUENTO_TOTAL'
...
## DESCUENTO_TARIFA_PLAN_ACT es igual a  discount_value y se esta filtrando con mrc_discount para validar si tienen los mismos valores y  que mrc no sea nulo             
    ...
    ##el DF: "df_descuento_actual" une en este todos los registros que se cruzaron con "df_tmp_cambio_plan_fnl" y "df_otc_t_descuentos_planes_act" y que cumplieron con las condiciones que "'MRC_DISCOUNT' = DESCUENTO_TARIFA_PLAN_ACT & 'MRC_DISCOUNT' isNotNull" donde se toma a (DESCUENTO_TARIFA_PLAN_ACT como DISCOUNT_VALUE). ESto se une solo con los registros que cumplen con el detalle_descuento "CONADIS" 
...
def fun_cargar_df_descuento_anterior(sqlContext, df_tmp_cambio_plan_fnl, df_parque_anterior, df_tmp_ov_desc_plan_new):
    ...
    ### para descuentos anteriores se toma MRC_DISCOUNT AS VALOR_DESCUENTO
    ### DISCOUNT_VALUE AS F_DISCOUNT_VALUE y MRC_DISCOUNT AS F_MRC_DISCOUNT
...
def fun_cargar_df_cambio_plan_fnl_int(sqlContext, df_tmp_cambio_plan_fnl, df_parque_anterior, df_override_actual, df_override_anterior, df_descuento_actual):
    ...
    ## para tdant debe ser df_descuento_anterior
    ...
    tabo_act_oant_dact = tabo_act_oant.join(tdact, expr(" tabo_act_oant.TELEFONO = tdact.TELEFONO "), how='left') \
                    .selectExpr('tabo_act_oant.ANIO_MES', 'tabo_act_oant.FECHA_CARGA', 'tabo_act_oant.TELEFONO', 'tabo_act_oant.NUMERO_ABONADO', 'tabo_act_oant.SEGMENTO', 'tabo_act_oant.SUB_SEGMENTO', 'tabo_act_oant.ESTADO_ABONADO', 'tabo_act_oant.DOCUMENTO_CLIENTE'
                        ...
                        ## aqui se esta tomando el valor de DESCUENTO_TOTAL que es discount_value_with_tax
    ...
    tabo_act_oant_dact = tabo_act_oant_dact.join(tdant, expr(" tabo_act_oant_dact.TELEFONO = tdant.TELEFONO "), how='left') \
                    .selectExpr('tabo_act_oant_dact.ANIO_MES', 'tabo_act_oant_dact.FECHA_CARGA', 'tabo_act_oant_dact.TELEFONO', 'tabo_act_oant_dact.NUMERO_ABONADO', 'tabo_act_oant_dact.SEGMENTO'
                                ...
                                ## se vuelve a tomar a DESCUENTO_TOTAL q es discount_value_with_tax
                                ## para tdant debe tomarse de df_descuento_anterior, VALOR_DESCUENTO que es MRC_DISCOUNT
